...
function initScrollAnimations() {
    ...
    const animateElements = document.querySelectorAll('.service-card, .vision-mission-card, .contact-card, .about-value-card');
...
console.log('%cTwo Edge Global Solutions', 'font-size: 24px; font-weight: bold; background: linear-gradient(to right, #fbe8af, #9c714b); -webkit-background-clip: text; -webkit-text-fill-color: transparent;');
